...
const MOCK_STAFF: StaffMember[] = [
  { id: 'admin-001', firstName: 'Sarah', lastName: 'Chen', email: 'sarah.chen@tradeconsole.net', role: 'super_admin', status: 'active', lastActive: '2026-08-27 14:40', createdAt: '2026-01-01', presenceStatus: 'online' },
  { id: 'broker-001', firstName: 'James', lastName: 'Park', email: 'james.park@tradeconsole.net', role: 'broker', status: 'active', lastActive: '2026-08-27 14:35', createdAt: '2026-04-01', managerId: 'bm-001', managerName: 'Sarah Chen', department: 'Sales', presenceStatus: 'online' },
  { id: 'broker-002', firstName: 'Emma', lastName: 'Wilson', email: 'emma.wilson@tradeconsole.net', role: 'broker', status: 'active', lastActive: '2026-08-27 14:20', createdAt: '2026-05-10', managerId: 'bm-001', managerName: 'Sarah Chen', department: 'Sales', presenceStatus: 'busy' },
  { id: 'ftd-001', firstName: 'Carlos', lastName: 'Mendez', email: 'carlos.mendez@tradeconsole.net', role: 'ftd_broker', status: 'active', lastActive: '2026-08-27 13:15', createdAt: '2026-06-01', managerId: 'cm-001', managerName: 'Robert Chen', department: 'Conversion', presenceStatus: 'online' },
  { id: 'ret-001', firstName: 'Maria', lastName: 'Santos', email: 'maria.santos@tradeconsole.net', role: 'retention_broker', status: 'active', lastActive: '2026-08-27 12:00', createdAt: '2026-03-15', managerId: 'rm-001', managerName: 'Lisa Wang', department: 'Retention', presenceStatus: 'away' },
  { id: 'comp-001', firstName: 'Yuki', lastName: 'Tanaka', email: 'yuki.tanaka@tradeconsole.net', role: 'compliance_broker', status: 'active', lastActive: '2026-08-27 11:30', createdAt: '2026-04-20', managerId: 'cm-001', managerName: 'Lisa Wang', department: 'Compliance', presenceStatus: 'online' },
  { id: 'aff-001', firstName: 'Marco', lastName: 'Rossi', email: 'marco.rossi@tradeconsole.net', role: 'affiliate', status: 'active', lastActive: '2026-08-27 10:00', createdAt: '2026-02-10', managerId: 'am-001', managerName: 'Elena Vasquez', presenceStatus: 'online' },
  { id: 'fin-001', firstName: 'David', lastName: 'Kim', email: 'david.kim@tradeconsole.net', role: 'finance', status: 'active', lastActive: '2026-08-27 14:00', createdAt: '2026-01-15', department: 'Finance', presenceStatus: 'online' },
  { id: 'vp-001', firstName: 'Robert', lastName: 'Chen', email: 'robert.chen@tradeconsole.net', role: 'vp_sales', status: 'active', lastActive: '2026-08-27 09:00', createdAt: '2026-01-01', presenceStatus: 'online' },
  { id: 'cm-001', firstName: 'Lisa', lastName: 'Wang', email: 'lisa.wang@tradeconsole.net', role: 'compliance_manager', status: 'active', lastActive: '2026-08-27 13:45', createdAt: '2026-02-01', department: 'Compliance', presenceStatus: 'online' },
  { id: 'bm-001', firstName: 'Sarah', lastName: 'Chen', email: 'sarah.chen2@tradeconsole.net', role: 'broker_manager', status: 'active', lastActive: '2026-08-27 14:40', createdAt: '2026-03-01', managerId: 'vp-001', managerName: 'Robert Chen', department: 'Sales', presenceStatus: 'online' },
  { id: 'sm-001', firstName: 'Alex', lastName: 'Torres', email: 'alex.torres@tradeconsole.net', role: 'shift_manager', status: 'active', lastActive: '2026-08-27 08:00', createdAt: '2026-05-01', presenceStatus: 'online' },
  { id: 'op-001', firstName: 'Anna', lastName: 'Kowalski', email: 'anna.kowalski@tradeconsole.net', role: 'operator', status: 'active', lastActive: '2026-08-27 14:10', createdAt: '2026-06-15', presenceStatus: 'online' },
  { id: 'tl-001', firstName: 'Liam', lastName: 'Johnson', email: 'liam.johnson@tradeconsole.net', role: 'team_leader', status: 'active', lastActive: '2026-08-27 13:00', createdAt: '2026-04-10', managerId: 'bm-001', managerName: 'Sarah Chen', presenceStatus: 'away' },
];
