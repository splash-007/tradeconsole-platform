  ...
  return (
    ...
    >
      ...
      <div className="relative shrink-0">
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs px-1.5 py-0.5 rounded text-gray-500" style={{ backgroundColor: '#111111', border: `1px solid ${termBorder}` }}>Spot</span>
              {realAvailable && (
        ...
        {dropdownOpen && (
          <div
            className="absolute top-full left-0 mt-1 w-52 rounded border shadow-xl z-50 overflow-hidden animate-fade-in"
          ...
          >
            {instruments.slice(0, 8).map(inst => (
              ...
              >
                ...
                <span className={`font-mono ${inst.changePct24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium border transition-all hover:bg-white/5"
          style={{ borderColor: termBorder, color: '#ffffff' }}
        >
        ...
        <button className="p-1.5 rounded transition-colors ml-1 text-gray-600 hover:text-white">
          <Star size={13} />
        </button>
        <button className="p-1.5 rounded transition-colors text-gray-600 hover:text-white">
          <Bell size={13} />
        </button>
      </div>
    </div>
