  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs font-semibold text-white tracking-wide uppercase">Market Overview</span>
      </div>
        ...
        {stats.map((stat, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold tabular-nums font-mono text-white">{stat.value}</span>
              {stat.change && (
